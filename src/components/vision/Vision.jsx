import visionstyle from './vision.module.css'

export function Vision(){
    return(
    <div className={visionstyle.quienes}>

    <div className={visionstyle.arriba}></div>
    
       <div className={visionstyle.frente}><h1>Visión</h1></div>
       
       <div className={visionstyle.prueba}>
       <div className={visionstyle.somos}>
...
servicio en su adultez.

       
       </div>
       <div className={visionstyle.abajo}></div>
